package com.tyss.ManyToManyBaiDiConnecter;
...
import com.tyss.ManyToManyBaiDi.Student;
import com.tyss.ManyToManyBaiDi.Teacher;
...
public static void main(String[] args) {
	...
	student1.setName("Priyadharshini");
	...
	t1.add(teacher1);
	t1.add(teacher);
    student1.setTeachers(t1);
	
	List<Teacher> t2=new ArrayList<Teacher>();
	t2.add(teacher2);
	t2.add(teacher3);
	student2.setTeachers(t2);
	
	List<Teacher> t4=new ArrayList<Teacher>();
	t4.add(teacher3);
	t4.add(teacher1);
    student3.setTeachers(t4);
	
	List<Teacher> t3=new ArrayList<Teacher>();
	t3.add(teacher2);
	t3.add(teacher1);
	student4.setTeachers(t3);
